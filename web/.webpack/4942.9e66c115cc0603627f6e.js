"use strict";(self.webpackChunk=self.webpackChunk||[]).push([[4942],{64942:(hn,c,n)=>{n.d(c,{L:()=>pn});var d=n(76635),m=n(87472);const f=[{fileName:"pointClouds.ts",sourceCode:`import { FieldReader, getReader } from "./readers";
...
`}];var r=n(23621),u=n(11701),p=n(81468),b=n(76878),h=n(96627),y=n(5812),g=n(73406),v=n(90748),w=n(62227),x=n(4211),T=n(12771),R=n(16691),P=n(25385),A=n(1902),z=n(40453),M=n(63799),I=n(96668),E=n(36860),C=n(36412),U=n(41831),j=n(24855),B=n(12555),D=n(9080),F=n(19463),S=n(22656),N=n(42192),O=n(34518),L=n(72931),G=n(88823),H=n(4092),V=n(57495),Y=n(31582),k=n(34607),$=n(66848),Q=n(67780),W=n(95681),X=n(39977),J=n(83597),K=n(32600),Z=n(39081),_=n(2642),q=n(56203),nn=n(70073),en=n(42772),a=n(48034),tn=n(48172),sn=n(83874),rn=n(39336),on=n(73634),an=n(86256),ln=n(87266),cn=n(52822);const o="lib.d.ts",dn=`
...
`,i=new Map(Object.entries({es5:cn,es2015:h,es2016:A,es2017:z,es2018:D,es2019:L,es2020:k,es2021:K,es2022:a,"es2015.core":b,"es2015.collection":p,"es2015.iterable":g,"es2015.generator":y,"es2015.promise":v,"es2015.proxy":w,"es2015.reflect":x,"es2015.symbol":T,"es2015.symbol.wellknown":R,"es2016.array.include":P,"es2017.object":I,"es2017.sharedmemory":E,"es2017.string":C,"es2017.intl":M,"es2017.typedarrays":U,"es2018.asynciterable":B,"es2018.asyncgenerator":j,"es2018.promise":S,"es2018.regexp":N,"es2018.intl":F,"es2019.array":O,"es2019.object":G,"es2019.string":H,"es2019.symbol":V,"es2020.bigint":Y,"es2020.promise":Q,"es2020.sharedmemory":W,"es2020.string":X,"es2020.symbol.wellknown":J,"es2020.intl":$,"es2021.intl":Z,"es2021.promise":_,"es2021.string":q,"es2021.weakref":nn,"es2022.array":en,"es2022.error":tn,"es2022.intl":sn,"es2022.object":rn,"es2022.regexp":on,"es2022.sharedmemory":an,"es2022.string":ln}));function l(e){return e.replace(/\/\/\/ <reference lib="(.+)" \/>/g,(bn,t)=>{const s=i.get(t);return i.delete(t),s==null?"":l(s)})}const mn=`${l(a)}

${dn}`;function fn(){return(0,d.sortBy)([...(0,m.exportTypeScriptSchemas)().entries()],([t])=>t).map(([t,s])=>({fileName:`@foxglove/schemas/${t}.ts`,filePath:`@foxglove/schemas/${t}.ts`,sourceCode:s.replaceAll(/export enum (\w+) {/g,"export const enum $1 {")}))}const un=f.map(e=>({...e,filePath:`${u.wd}${e.fileName}`}));function pn(){const e=[];return e.push({fileName:o,filePath:o,sourceCode:mn}),e.push(...fn()),{defaultLibFileName:o,rosLib:{fileName:r.Y,filePath:`/node_modules/${r.Y}`,sourceCode:r.k},declarations:e,utilityFiles:un}}}}]);

//# sourceMappingURL=4942.9e66c115cc0603627f6e.js.map